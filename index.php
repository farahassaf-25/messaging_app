...
<head>
    ...
    <title>ConvoConnect | Welcome</title>
</head>

<body data-bs-spy="scroll" data-bs-target=".navbar" class="p-2">
    <nav class="col-md-2 sidebar d-flex flex-column justify-content-between position-fixed">
        <div class="logo text-center py-4">
            <img src="../assets/logo.svg" alt="logo" width="64px" height="64px" class="logo-img" />
        </div>
        <ul class="nav flex-column flex-grow-1 justify-content-between">
    ...
    <div class="content-wrapper col-md-11 offset-md-1">
        <section id="home" class="full-height px-lg-5 main-content bg-white mb-5">
            <div class="container">
                <div class="row d-flex align-items-center">
                    <div class="col-lg-6">
                        <h1 class="display-4 fw-bold mb-5">Welcome to <span class="text-brand">CONVOCONNECT</span><br> your messaging app</h1>
                        <div class="btn-container">
                            <a class="btn-content ping" href="users/login.php">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8">
                        ...
                        <form id="subsFrm" method="post">
                            <input type="text" id="name" placeholder="Full Name" required class="form-control mb-3">
                            <input type="email" id="email" placeholder="E-mail" required class="form-control mb-4">
                            <input type="button" id="subscribeBtn" value="Subscribe Now" class="btn btn-primary w-100">
                        </form>
                        <div id="response" class="mt-3 response-subscribe"></div>
                    </div>
                </div>
            </div>
        </section>
    ...
    <script src="landing/scripts/subscribe.js"></script>
